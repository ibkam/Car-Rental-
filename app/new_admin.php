...
if (isset($_POST['submitt'])) {
	...
	function saverec(){
		...
		global $pdo,$username,$password,$user_type;

		try {

		 			 $save = $pdo->prepare("INSERT INTO users(user_type,username,password) VALUES(?,?,?)");	 
		 			 $save -> bindValue(1,$user_type);
		 			 $save -> bindValue(2,$username);
		 			 $save -> bindValue(3,$password);
		 			 $save -> execute();
...
<meta name="viewport" content="width=device-width, initial-scale=1">
  <title>Car Hire System | New Administrator </title>
...
<body>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">		
		<div class="row">
			<ol class="breadcrumb">
				<li><a href="#"><i class="glyphicon glyphicon-user"></i>&nbsp;&nbsp; New Administrator</a> </li>
	...
	<!--/.row-->
		...
		<br/>
			...
			<div class="panel panel-default">
					<div class="panel-heading"><i class="glyphicon glyphicon-user"></i> Add New Administrator </div>
