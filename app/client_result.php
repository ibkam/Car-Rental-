...
<meta name="viewport" content="width=device-width, initial-scale=1">
 <title>Car Hire System | Clients </title>
...
echo "<tbody><tr><td>".$ref."</td><td>".$name."</td><td>".$id_no."</td><td>".$email."</td><td>".$phone."</td></td><td><a href='client_book.php?id=".$phone."' data-rel='collapse'><i class='glyphicon glyphicon-shopping-cart'></i> view orders</a></td></tr></tbody>";
