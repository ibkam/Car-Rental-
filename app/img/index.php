...
<head>
    ...
    <title>Car Hire System ::. Home </title>
...
<!-- End WOWSlider.com BODY section -->
    ...
    <div class="container">
        ...
        <footer>
            <div class="row">
                <div class="col-lg-12">
                    <p>Copyright &copy; <?php echo date('Y');?> Car Hire System &nbsp;&nbsp; | &nbsp;&nbsp; Designed & Developed By <a href="">DAVID NGINYO </a>&nbsp;&nbsp; | &nbsp;&nbsp; <a href="app/login.php">Site Admin</a> </p>
                </div>
            </div>
        </footer>
