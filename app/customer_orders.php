...
<meta name="viewport" content="width=device-width, initial-scale=1">
 <title>Car Wash System | Client Booking</title>
...
<body>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">		
		<div class="row">
			<ol class="breadcrumb">
				<li><a href="#"><svg class="glyph stroked bag"><use xlink:href="#stroked-bag"></use></svg> Customer Orders</a> </li>
	...
	<!--/.row-->
		...
		<br/>
			...
			<div class="panel panel-default">
					<div class="panel-heading"><svg class="glyph stroked bag"><use xlink:href="#stroked-bag"></use></svg>New Orders</div>
					<div class="panel-body">
					<?php
					global $pdo,$id;
					$order=$pdo->prepare("SELECT * FROM bookings WHERE order_stat = 'new' ORDER BY id DESC");
					$order->bindValue(1,$id);		
					$order->execute();
					$rows=$order->rowCount();
		 	
					echo "<table cellpadding='0' cellspacing='0' border='0' class='table table-striped table-bordered'><thead><tr><th>#</th><th>Order Date</th><th>Vehicle ID</th><th>Client</th><th></th></tr></thead>";
				...
				echo "<tbody><tr><td>".$ref."</td><td>".$bdate."</td><td>".$service."</td><td>".$sdate."</td><td><a href='payment.php?id=".$ref."&veh_id=".$service."' data-rel='collapse'><i class='glyphicon glyphicon-credit-card'></i> Settle Payment</a></td></tr></tbody>";
