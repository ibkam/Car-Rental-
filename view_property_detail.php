...
if (isset($_POST['save'])) {
    ...
    function saveclient(){
        ...
        try {
          ...
          $saveclient = $pdo->prepare("INSERT INTO clients(fname,id_no,email,phone) VALUES(?,?,?,?)");
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        <div class="container">
            ...
            <div class="navbar-header">
                ...
                <b><a class="navbar-brand" href="index.php"> Car Wash System</a></b>
            </div>
...
<br/>
    ...
    <div class="container">
        ...
        <div class="col-md-6" style="margin-left:73px;">
                 <div class="list-group">
                <div class="list-group">
                    <a href="" class="list-group-item active"><i class="glyphicon glyphicon-user"></i> 
                    Register Customer | Vehicle Details</a>
                     <form role="form" action="<?php $_SERVER['PHP_SELF']?>" method="POST" >
                            ...
                            <div class="form-group">
                             ...
                             <div class="form-group">
                                ...
                                <input type="Reg No" class="form-control"   minlength="7" name="Reg No">
...
<br/>
    ...
    <div class="container">
        ...
        <footer>
            <div class="row">
                <div class="col-lg-12">
                    <p>Copyright &copy; <?php echo date('Y');?> Car Wash Management  System &nbsp;&nbsp; | &nbsp;&nbsp; Designed & Developed By <a href="">PATRICK</a>&nbsp;&nbsp; | &nbsp;&nbsp; <a href="">Site</a> </p>
                </div>
            </div>
        </footer>
